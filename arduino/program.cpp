...
constexpr uint8_t VENT12V_PIN = A1;
...
constexpr float VOLTS_PER_STEP = 5.0 / 1023.0;
constexpr bool ECO_MODE = false;
...
void setSpeed(float temp) {
    const int speed = constrain(map(temp, 0, TEMP_ALERT_THRESHOLD, 0, 180), FAN_MIN_SPEED, FAN_MAX_SPEED);
